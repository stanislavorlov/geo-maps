class TravelTimeService:
    ...
    def calculate_travel_time(self, distance_meters: float, speed_mph: float, in_minutes: bool = True) -> float:
        """
        ...
        if in_minutes:
            return distance_meters / (speed_mph * self.MPH_TO_METERS_PER_MINUTE)
        else:
            return distance_meters / (speed_mph * self.MPH_TO_METERS_PER_SECOND)